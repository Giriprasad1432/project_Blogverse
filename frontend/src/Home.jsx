    ...
    return (
        <div className=" flex flex-col items-center justify-center ">
            ...
            <div className="flex flex-col gap-5">
                ...
                <h1 className="md:text-2xl text-gray-500 md:w-200 text-center">Discover amazing stories, insights, and ideas from our community of writers.<span className="cursor-pointer hover:underline text-blue-400">Sign in</span> to create your own posts and save your favorites.</h1>
            </div>
            <div className="flex flex-wrap gap-15 w-[70%] mt-10 justify-center">
                {Posts.map((post) => {
                    return (
                        <div className="transition-transform duration-500 border-1 border-gray-300 rounded-2xl h-90 md:h-fit shadow-lg shadow-gray-300 w-100 hover:shadow-gray-500 hover:scale-101">
                            <div className="relative flex">
                                <img src={post.img} className="w-full md:h-50 h-40 rounded-t-2xl "></img>
                            ...
                            <div className="flex flex-col gap-0.5 md:gap-3 md:mt-3 mt-1 px-4">
                                ...
                                <p className="px-3 text-xs md:text-sm text-gray-500">{post.description}</p>
                                <div className="border-1 border-gray-300"></div>
                                <div className="flex justify-between md:py-2 py-0.7">
                                    <p className="md:text-sm text-xs px-2 py-1">{post.read_time}</p>
                                    <p className="text-blue-500 text-md md:text-md">Read more</p>
                                </div>
                            </div>
                        </div>
